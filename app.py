...
def pengujian():
    ...
    vectorizer = DeltaTfidfVectorizer(min_df=0.0, max_df=1.0, sublinear_tf=True, use_idf=True, stop_words='english')

    X_train_tf = vectorizer.fit_transform(X_train, y_train)
